...
public class BudgetPlanningActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_budget_planning, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position){
                case 0:
                    FragmentBudgetPlanning_Spendings tab1 = new FragmentBudgetPlanning_Spendings();
                    return tab1;
                case 1:
                    FragmentBudgetPlanning_AddExpense tab2 = new FragmentBudgetPlanning_AddExpense();
                    return tab2;
                case 2:
                    FragmentBudgetPlanning_BudgetPlan tab3 = new FragmentBudgetPlanning_BudgetPlan();
                    return tab3;
            }
            return null;
        }
