...
/*
    ...
    public Expense(EntryCategory category, String description, double amount) {
        this.category = category;
        this.description = description;
        this.amount = amount;
    }

    public Expense(long _id, EntryCategory category, long time, String description, double amount) {
        this._id = _id;
        this.category = category;
        this.description = description;
        this.amount = amount;
